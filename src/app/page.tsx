...
export default function Home() {
  return (
    <div
      className="w-screen h-screen bg-[url('/neuCampusBlurred.png')] overflow-hidden bg-cover bg-center bg-no-repeat ] flex flex-col">
      <Header/>
      <div className="flex w-full h-full justify-center items-center">
        <div
          ...
          <Button className="w-[12vw] min-w-[129px]" asChild><Link href="/auth/login">Get Started</Link></Button>
