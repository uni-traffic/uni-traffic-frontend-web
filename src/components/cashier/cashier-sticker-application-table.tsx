...
import { AssignStickerModal } from "@/components/cashier/assign-sticker-modal";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
const CashierStickerApplicationTable = ({ applications }: ApplicationsTableProps) => {
...
export default CashierStickerApplicationTable;
