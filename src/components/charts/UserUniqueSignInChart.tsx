...
import { useTotalUniqueSignInsByRange } from "@/hooks/userSignInActivity/useTotalUniqueSignInsByRange";
...
const UserUniqueSignInChart = ({ className }: UniqueSignInChartProps) => {
...
export default UserUniqueSignInChart;
